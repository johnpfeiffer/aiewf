// Auto-generated from the AI Engineer World's Fair 2026 open schedule data
// (sessions.json + speakers.json, scheduleVersion 4652).
// Day 2 (Tuesday, June 30, 2026). Do not edit by hand; re-generate from the open data.
...
export type SessionType = "KEYNOTE" | "SESSION" | "SPONSOR";
...
export const scheduleSessions: ScheduleSession[] = [
  ...
  },
  {
    ...
    speakers: [{ name: "Martin Harrysson", role: "Senior Partner, McKinsey & Company" }, { name: "Matt Linderman", role: "Partner, Technology Practice, McKinsey & Company" }, { name: "Prakhar Dixit", role: "Partner, McKinsey" }],
    description: "*Facilitated, peer-to-peer, under the Chatham House Rule — not recorded.*\n\nThe product development lifecycle is being redesigned around reusable skills that accelerate work across both technical and non-technical workflows. We will share practical examples across ideation, planning, product validation, launch and testing — and look forward to hearing what you are building.",
  },
  {
    id: "d2-025",
    type: "SESSION",
  ...
  },
  {
    ...
    speakers: [{ name: "Jacqueline Wood", role: "Staff Machine Learning Engineer, Spotify" }, { name: "Yves Raimond", role: "SVP/GM, AI & Personalization, Spotify" }],
    description: "",
  },
  {
    id: "d2-035",
  ...
  },
  {
    ...
    description: "Since its origins at Palantir, the term \"Forward Deployed Engineer\" has described wildly different jobs, yet today it's one of the fastest-growing roles in AI. What happened? And what does that reveal about the future of engineering?\n\nJoin Nat Meurer, Head of Agent Engineering at Sierra, for a historical tour of one of tech's most misunderstood roles, and why its biggest contradiction may explain where the industry is headed next.",
  },
  {
    id: "d2-082",
    type: "SESSION",
  ...
  },
  {
    ...
    speakers: [{ name: "Salil Subbakrishna", role: "" }],
    description: "AI agents are reshaping CI/CD. See how workflows become adaptive—understanding failures, fixing issues, and accelerating releases without constant manual intervention.",
  },
  {
    id: "d2-087",
    type: "SPONSOR",
  ...
  },
  {
    ...
    description: "MCP, skills, Cli - so much noise - what’s the best way for agents to communicate",
  },
  {
    id: "d2-108",
    type: "SESSION",
  ...
  },
  {
    ...
    startMin: 865, endMin: 885,
    tentative: true,
    title: "River: Shopify’s Slack-Native AI Agent",
  ...
  },
  {
    ...
    speakers: [{ name: "Maria Bledsoe", role: "" }],
    description: "Becoming AI-ready starts with modernizing your legacy systems and technical debt — and keeping them modernized. We’ll show how you can use agentic AI to take on the hardest parts of modernization: analyzing large codebases, mapping dependencies, planning upgrades, refactoring safely, while doing it all at scale with enterprise controls. With GitHub Copilot modernization capabilities, you can move from legacy complexity to modernized apps in days, not months.",
  },
  {
    id: "d2-117",
    type: "SPONSOR",
